...
export const ADMIN = {
  kpis: { students: ALL_STUDENTS.length, activeToday: ALL_STUDENTS.filter((s) => s.status !== 'not_started').length, completion: 79, turnaroundHrs: 9, seatsLeft: 200 - ALL_STUDENTS.length },
  alerts: [
    ...
    { tone: 'brand', text: 'Batch D has 27 seats free. Dr. Vikram Menon can upload the rest of his sheet.', when: 'Yesterday' },
